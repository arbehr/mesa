...
class LearningObjectAgent(mesa.Agent):
    ...
    def __init__(self, unique_id, on_main_page, model):
        ...
        self.intrinsicValue = round(self.random.uniform(0.1, 0.6),2)
        self.socialNetwork = 0
        self.mainPage = 0
        self.refactored = 0
        self.attractivity = self.intrinsicValue + self.mainPage + self.socialNetwork
    ...
    def do_action(self):
        ...
        if isinstance(cellmates[0], LearningObjectAgent):
            ...
            if self.action == 0:
                ...
                for i in range(self.timesTrySelect):
                    if(action_probability <= (cellmates[0].attractivity)):
                ...
                if(action_probability <= self.model.download_chance):
                    ...
                    cellmates[0].downloadsInCycle += 1
